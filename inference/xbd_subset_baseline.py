...
# nohup python inference/xbd_subset_baseline.py > ./logs/subset_baseline.log &

# Set up logging
log_file = "./logs/subset_baseline.log"
...
output_file_path = "./output/xbd_subset_baseline.jsonl"
